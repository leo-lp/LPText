...
@interface YYLabel() <YYTextDebugTarget, LPAsyncLayerDelegate> {
...
- (void)_initLabel {
    ((LPAsyncLayer *)self.layer).isDisplaysAsynchronously = NO;
...
- (void)setDisplaysAsynchronously:(BOOL)displaysAsynchronously {
    ...
    ((LPAsyncLayer *)self.layer).isDisplaysAsynchronously = displaysAsynchronously;
}
...
- (LPAsyncLayerDisplayTask *)newAsyncDisplayTask {
    ...
    // create display task
    LPAsyncLayerDisplayTask *task = [LPAsyncLayerDisplayTask new];
